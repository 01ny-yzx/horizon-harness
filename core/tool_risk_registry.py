...
_LOCAL_TOOL_RISK_METADATA: dict[str, ToolRiskMetadata] = {
    ...
    "forget_memory": _meta("forget_memory", family="memory", operation=STATE_MUTATION, side_effect=True, boundary_categories=("state_mutation",)),
    ...
    "list_memories": _meta("list_memories", family="memory", operation=READ),
